...
class RiwayatAdapter(private var penggajianList: List<Penggajian>) :
    RecyclerView.Adapter<RiwayatAdapter.PenggajianViewHolder>() {
    ...
    inner class PenggajianViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(penggajian: Penggajian) {
            ...
            val totalGaji = (penggajian.gaji1 + penggajian.gaji2 + penggajian.bonus) / 2
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PenggajianViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.list_riwayat_penggajian, parent, false)
